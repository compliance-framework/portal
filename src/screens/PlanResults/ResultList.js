...
var ResultList = function (_a) {
    ...
    var toolbar = (<a href={""} className="underline">
      See All
    </a>);
    var items = (0, react_1.useMemo)(function () {
        return results.map(function (result) {
            ...
            return ({
                ...
                observations: (_b = (_a = result.observations) === null || _a === void 0 ? void 0 : _a.length) !== null && _b !== void 0 ? _b : 0,
                risks: (_d = (_c = result.risks) === null || _c === void 0 ? void 0 : _c.length) !== null && _d !== void 0 ? _d : 0, // TODO
            });
        });
    }, [results]);
    // const items2 = [
    ...
    //   },
    // ];
    return (<Widget_1.Widget title={t("widgets.assessment.result.list")} toolbar={toolbar}>
      <WidgetContent_1.WidgetContent>
        <div className="flex flex-col">
          {items.map(function (item) { return (<div className="flex flex-col border-b border-gray-500 py-4">
