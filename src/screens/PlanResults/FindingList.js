...
exports.FindingList = (0, mobx_react_lite_1.observer)(function (_a) {
    var id = _a.id, resultId = _a.resultId;
    ...
    (0, react_1.useEffect)(function () {
        (function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, config_1.API.configurationService.plan.planIdResultsResultIdFindingsGet(id, resultId)];
                    case 1:
                        response = _a.sent();
    ...
    return (<Widget_1.Widget title={t("widgets.assessment.finding.list")} toolbar={toolbar}>
      <WidgetContent_1.WidgetContent>
        <div className="flex flex-col">
          {items.map(function (item) { return (<div className="flex flex-row border-b border-gray-500 py-2">
