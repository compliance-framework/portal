...
export class CatalogApi extends BaseAPI {
  ...
  public apiCatalogPost(handlerCreateCatalogRequest: HandlerCreateCatalogRequest, options?: AxiosRequestConfig) {
    return CatalogApiFp(this.configuration)
      .apiCatalogPost(handlerCreateCatalogRequest, options)
...
export const MetadataApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async apiMetadataRevisionsPost(
      ...
      const localVarAxiosArgs = await localVarAxiosParamCreator.apiMetadataRevisionsPost(
        handlerAttachMetadataRequest,
        options,
      );
      return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
...
export const MetadataApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    apiMetadataRevisionsPost(
      handlerAttachMetadataRequest: HandlerAttachMetadataRequest,
      options?: any,
    ): AxiosPromise<string> {
      return localVarFp
        .apiMetadataRevisionsPost(handlerAttachMetadataRequest, options)
...
export class MetadataApi extends BaseAPI {
   ...
   */
  public apiMetadataRevisionsPost(
    handlerAttachMetadataRequest: HandlerAttachMetadataRequest,
    options?: AxiosRequestConfig,
  ) {
