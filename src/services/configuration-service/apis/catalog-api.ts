...
import { HandlerCatalogIdResponse, HandlerCreateCatalogRequest } from "../models";
/**
...
export const CatalogApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
    ...
    apiCatalogPost: async (
      body: HandlerCreateCatalogRequest,
...
export const CatalogApiFp = function (configuration?: Configuration) {
  return {
    ...
    async apiCatalogPost(
      body: HandlerCreateCatalogRequest,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<HandlerCatalogIdResponse>>> {
...
export const CatalogApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
  return {
    ...
    async apiCatalogPost(
      body: HandlerCreateCatalogRequest,
      options?: AxiosRequestConfig,
    ): Promise<AxiosResponse<HandlerCatalogIdResponse>> {
      return CatalogApiFp(configuration)
        .apiCatalogPost(body, options)
