...
export const PlanApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
    ...
    apiPlanIdTasksPost: async (
      ...
      if (body === null || body === undefined) {
        throw new RequiredError(
          "body",
          "Required parameter body was null or undefined when calling apiPlanIdTasksPost.",
        );
      }
    ...
    apiPlanIdTasksTaskIdActivitiesPost: async (
      body: HandlerCreateActivityRequest,
      id: number,
      taskId: number,
      options: AxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      ...
      if (body === null || body === undefined) {
        throw new RequiredError(
          "body",
          "Required parameter body was null or undefined when calling apiPlanIdTasksTaskIdActivitiesPost.",
        );
      }
      // verify required parameter 'id' is not null or undefined
      if (id === null || id === undefined) {
        throw new RequiredError(
          "id",
          "Required parameter id was null or undefined when calling apiPlanIdTasksTaskIdActivitiesPost.",
        );
      }
      ...
      if (taskId === null || taskId === undefined) {
        throw new RequiredError(
          "taskId",
          "Required parameter taskId was null or undefined when calling apiPlanIdTasksTaskIdActivitiesPost.",
        );
      }
...
export const PlanApiFp = function (configuration?: Configuration) {
  return {
    ...
    async apiPlanIdTasksTaskIdActivitiesPost(
      ...
      taskId: number,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<HandlerIdResponse>>> {
      const localVarAxiosArgs = await PlanApiAxiosParamCreator(configuration).apiPlanIdTasksTaskIdActivitiesPost(
        body,
        id,
        taskId,
        options,
    ...
    async planIdResultsGet(
      id: string,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<Array<DomainResult>>>> {
...
export const PlanApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
  return {
    ...
    async apiPlanIdTasksPost(
      ...
      return PlanApiFp(configuration)
        .apiPlanIdTasksPost(body, id, options)
    ...
    async apiPlanIdTasksTaskIdActivitiesPost(
      ...
      taskId: number,
      options?: AxiosRequestConfig,
    ): Promise<AxiosResponse<HandlerIdResponse>> {
      return PlanApiFp(configuration)
        .apiPlanIdTasksTaskIdActivitiesPost(body, id, taskId, options)
        .then(request => request(axios, basePath));
    },
    /**
     * Creates a new plan in the system
...
export class PlanApi extends BaseAPI {
   ...
   * @memberof PlanApi
   */
  public async apiPlanIdTasksPost(
    body: HandlerCreateTaskRequest,
    id: string,
    options?: AxiosRequestConfig,
  ): Promise<AxiosResponse<string>> {
   ...
   * @memberof PlanApi
   */
  public async apiPlanIdTasksTaskIdActivitiesPost(
    body: HandlerCreateActivityRequest,
    id: number,
    taskId: number,
    options?: AxiosRequestConfig,
