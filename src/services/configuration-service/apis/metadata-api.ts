...
export const MetadataApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
     ...
     */
    apiMetadataRevisionsPost: async (
      body: HandlerAttachMetadataRequest,
      ...
      if (body === null || body === undefined) {
        throw new RequiredError(
          "body",
          "Required parameter body was null or undefined when calling apiMetadataRevisionsPost.",
        );
      }
...
export const MetadataApiFp = function (configuration?: Configuration) {
  return {
     ...
     * @throws {RequiredError}
     */
    async apiMetadataRevisionsPost(
      body: HandlerAttachMetadataRequest,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<string>>> {
      const localVarAxiosArgs = await MetadataApiAxiosParamCreator(configuration).apiMetadataRevisionsPost(
        body,
        options,
      );
  ...
  return {
    ...
    async apiMetadataRevisionsPost(
      ...
      return MetadataApiFp(configuration)
        .apiMetadataRevisionsPost(body, options)
...
export class MetadataApi extends BaseAPI {
   ...
   */
  public async apiMetadataRevisionsPost(
    body: HandlerAttachMetadataRequest,
    options?: AxiosRequestConfig,
  ): Promise<AxiosResponse<string>> {
