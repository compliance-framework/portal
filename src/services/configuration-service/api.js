...
exports.PlanApi = exports.PlanApiFactory = exports.PlanApiFp = exports.PlanApiAxiosParamCreator = exports.MetadataApi = exports.MetadataApiFactory = exports.MetadataApiFp = exports.MetadataApiAxiosParamCreator = exports.CatalogApi = exports.CatalogApiFactory = exports.CatalogApiFp = exports.CatalogApiAxiosParamCreator = exports.ServiceRiskState = exports.ServiceRiskSeverity = void 0;
        ...
        catalogPost: function (handlerCreateCatalogRequest, options) {
            ...
            return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    ...
                    localVarRequestOptions.data = (0, common_1.serializeDataIfNeeded)(handlerCreateCatalogRequest, localVarRequestOptions, configuration);
                    return [2 /*return*/, {
    ...
    return {
        ...
        catalogPost: function (handlerCreateCatalogRequest, options) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, localVarAxiosParamCreator.catalogPost(handlerCreateCatalogRequest, options)];
                        case 1:
...
var CatalogApiFactory = function (configuration, basePath, axios) {
    ...
    return {
         ...
         */
        catalogPost: function (handlerCreateCatalogRequest, options) {
            return localVarFp.catalogPost(handlerCreateCatalogRequest, options).then(function (request) { return request(axios, basePath); });
        },
    };
};
        ...
        metadataRevisionsPost: function (handlerAttachMetadataRequest, options) {
            ...
            return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    ...
                    (0, common_1.assertParamExists)("metadataRevisionsPost", "handlerAttachMetadataRequest", handlerAttachMetadataRequest);
                    ...
                    headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
                    localVarRequestOptions.headers = __assign(__assign(__assign({}, localVarHeaderParameter), headersFromBaseOptions), options.headers);
                    localVarRequestOptions.data = (0, common_1.serializeDataIfNeeded)(handlerAttachMetadataRequest, localVarRequestOptions, configuration);
                    return [2 /*return*/, {
                            url: (0, common_1.toPathString)(localVarUrlObj),
                            options: localVarRequestOptions,
                        }];
    ...
    return {
        ...
        metadataRevisionsPost: function (handlerAttachMetadataRequest, options) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, localVarAxiosParamCreator.metadataRevisionsPost(handlerAttachMetadataRequest, options)];
                        case 1:
                            localVarAxiosArgs = _a.sent();
                            return [2 /*return*/, (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)];
                    }
        ...
        planIdTasksPost: function (id, handlerCreateTaskRequest, options) {
            ...
            return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    ...
                    headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
                    localVarRequestOptions.headers = __assign(__assign(__assign({}, localVarHeaderParameter), headersFromBaseOptions), options.headers);
                    localVarRequestOptions.data = (0, common_1.serializeDataIfNeeded)(handlerCreateTaskRequest, localVarRequestOptions, configuration);
                    return [2 /*return*/, {
                            url: (0, common_1.toPathString)(localVarUrlObj),
                            options: localVarRequestOptions,
                        }];
        ...
        planIdTasksTaskIdActivitiesPost: function (id, taskId, handlerCreateActivityRequest, options) {
            ...
            return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    ...
                    (0, common_1.assertParamExists)("planIdTasksTaskIdActivitiesPost", "handlerCreateActivityRequest", handlerCreateActivityRequest);
                    ...
                    headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
                    localVarRequestOptions.headers = __assign(__assign(__assign({}, localVarHeaderParameter), headersFromBaseOptions), options.headers);
                    localVarRequestOptions.data = (0, common_1.serializeDataIfNeeded)(handlerCreateActivityRequest, localVarRequestOptions, configuration);
                    return [2 /*return*/, {
                            url: (0, common_1.toPathString)(localVarUrlObj),
                            options: localVarRequestOptions,
                        }];
        ...
        planPost: function (handlerCreatePlanRequest, options) {
            ...
            return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    ...
                    headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
                    localVarRequestOptions.headers = __assign(__assign(__assign({}, localVarHeaderParameter), headersFromBaseOptions), options.headers);
                    localVarRequestOptions.data = (0, common_1.serializeDataIfNeeded)(handlerCreatePlanRequest, localVarRequestOptions, configuration);
                    return [2 /*return*/, {
                            url: (0, common_1.toPathString)(localVarUrlObj),
                            options: localVarRequestOptions,
                        }];
    ...
    return {
        ...
        planIdActivatePut: function (id, options) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, localVarAxiosParamCreator.planIdActivatePut(id, options)];
                        case 1:
                            localVarAxiosArgs = _a.sent();
                            return [2 /*return*/, (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)];
                    }
        ...
        planIdResultsGet: function (id, options) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, localVarAxiosParamCreator.planIdResultsGet(id, options)];
                        case 1:
                            localVarAxiosArgs = _a.sent();
                            return [2 /*return*/, (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)];
                    }
        ...
        planIdResultsResultIdComplianceOverTimeGet: function (id, resultId, options) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, localVarAxiosParamCreator.planIdResultsResultIdComplianceOverTimeGet(id, resultId, options)];
                        case 1:
                            localVarAxiosArgs = _a.sent();
                            return [2 /*return*/, (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)];
                    }
        ...
        planIdResultsResultIdComplianceStatusByTargetsGet: function (id, resultId, options) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, localVarAxiosParamCreator.planIdResultsResultIdComplianceStatusByTargetsGet(id, resultId, options)];
                        case 1:
                            localVarAxiosArgs = _a.sent();
                            return [2 /*return*/, (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)];
                    }
        ...
        planIdResultsResultIdFindingsGet: function (id, resultId, options) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, localVarAxiosParamCreator.planIdResultsResultIdFindingsGet(id, resultId, options)];
                        case 1:
                            localVarAxiosArgs = _a.sent();
                            return [2 /*return*/, (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)];
                    }
        ...
        planIdResultsResultIdObservationsGet: function (id, resultId, options) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, localVarAxiosParamCreator.planIdResultsResultIdObservationsGet(id, resultId, options)];
                        case 1:
                            localVarAxiosArgs = _a.sent();
                            return [2 /*return*/, (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)];
                    }
        ...
        planIdResultsResultIdRemediationVsTimeGet: function (id, resultId, options) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, localVarAxiosParamCreator.planIdResultsResultIdRemediationVsTimeGet(id, resultId, options)];
                        case 1:
                            localVarAxiosArgs = _a.sent();
                            return [2 /*return*/, (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)];
                    }
        ...
        planIdResultsResultIdRisksGet: function (id, resultId, options) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, localVarAxiosParamCreator.planIdResultsResultIdRisksGet(id, resultId, options)];
                        case 1:
                            localVarAxiosArgs = _a.sent();
                            return [2 /*return*/, (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)];
                    }
        ...
        planIdResultsResultIdSummaryGet: function (id, resultId, options) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, localVarAxiosParamCreator.planIdResultsResultIdSummaryGet(id, resultId, options)];
                        case 1:
                            localVarAxiosArgs = _a.sent();
                            return [2 /*return*/, (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)];
                    }
        ...
        planIdTasksPost: function (id, handlerCreateTaskRequest, options) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, localVarAxiosParamCreator.planIdTasksPost(id, handlerCreateTaskRequest, options)];
                        case 1:
                            localVarAxiosArgs = _a.sent();
                            return [2 /*return*/, (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)];
                    }
        ...
        planIdTasksTaskIdActivitiesPost: function (id, taskId, handlerCreateActivityRequest, options) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, localVarAxiosParamCreator.planIdTasksTaskIdActivitiesPost(id, taskId, handlerCreateActivityRequest, options)];
                        case 1:
                            localVarAxiosArgs = _a.sent();
                            return [2 /*return*/, (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)];
                    }
        ...
        planPost: function (handlerCreatePlanRequest, options) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, localVarAxiosParamCreator.planPost(handlerCreatePlanRequest, options)];
                        case 1:
                            localVarAxiosArgs = _a.sent();
                            return [2 /*return*/, (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)];
                    }
...
var PlanApiFactory = function (configuration, basePath, axios) {
    ...
    return {
         ...
         */
        planIdActivatePut: function (id, options) {
            return localVarFp.planIdActivatePut(id, options).then(function (request) { return request(axios, basePath); });
        },
        /**
         * Return the assessment results related with the plan with the given ID.
         * @summary Return the assessment results
         ...
         */
        planIdResultsGet: function (id, options) {
            return localVarFp.planIdResultsGet(id, options).then(function (request) { return request(axios, basePath); });
        },
        /**
         * Return the compliance over time of the result with the given ID.
         * @summary Return the compliance over time
         ...
         */
        planIdResultsResultIdRisksGet: function (id, resultId, options) {
            return localVarFp.planIdResultsResultIdRisksGet(id, resultId, options).then(function (request) { return request(axios, basePath); });
        },
        /**
         * Return the summary of the result with the given ID.
         * @summary Return the result summary
         ...
         */
        planPost: function (handlerCreatePlanRequest, options) {
            return localVarFp.planPost(handlerCreatePlanRequest, options).then(function (request) { return request(axios, basePath); });
        },
    };
};
