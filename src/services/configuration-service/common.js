...
var serializeDataIfNeeded = function (value, requestOptions, configuration) {
  ...
  var needsSerialization =
    nonString && configuration && configuration.isJsonMime
      ? configuration.isJsonMime((_a = requestOptions.headers) === null || _a === void 0 ? void 0 : _a["Content-Type"])
      : nonString;
...
var createRequestFunction = function (axiosArgs, globalAxios, BASE_PATH, configuration) {
  return function (axios, basePath) {
    ...
    var axiosRequestArgs = __assign(__assign({}, axiosArgs.options), {
      url:
        ((configuration === null || configuration === void 0 ? void 0 : configuration.basePath) ||
